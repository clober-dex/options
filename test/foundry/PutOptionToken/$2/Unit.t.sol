...
//import "../../../../contracts/arbitrum/Arbitrum$2PutOption.sol";
//
//contract $2PutOptionUnitTest is Test {
...
//
//    Arbitrum$2PutOption optionToken;
//
...
//
//        optionToken = new Arbitrum$2PutOption(address(underlyingToken), address(quoteToken), 1 days);
//
...
//        optionToken.write(1);
//
//        uint256 _maximumAmountToRevert = 10**(18 - quoteToken.decimals()) / 2 - 1;
//        vm.expectRevert("INVALID_AMOUNT");
//        optionToken.write(_maximumAmountToRevert);
//
//        uint256 _minimumAmountToNotRevert = 10**(18 - quoteToken.decimals()) / 2;
...
//            expectedQuoteAmount: (4000 * (10**quoteToken.decimals()) * (Constants.FEE_PRECISION - Constants.FEE)) /
...
//            expectedQuoteAmount: ((6666666 * (Constants.FEE_PRECISION - Constants.FEE)) / Constants.FEE_PRECISION) + 1,
//            // underlying and option decimals are same
...
//            expectedQuoteAmount: 6000 * (10**quoteToken.decimals()),
//            // No one exercised, so underlying amount is 0
//            expectedUnderlyingAmount: 0
//        });
//    }
...
//            user: Constants.WRITER1,
//            expectedOptionAmount: _optionAmount1,
//            // 4000 * 1e6 * (4000 * 1e18 / (4000 * 1e18 + 1000 * 1e18))
//            expectedQuoteAmount: (4000 * (10**quoteToken.decimals()) * 4) / 5,
...
//            user: Constants.WRITER1,
//            expectedOptionAmount: _optionAmount1,
//            // 4000 * 1e6 * (3000 * 1e18 / (3000 * 1e18 + 2000 * 1e18))
//            expectedQuoteAmount: (4000 * (10**quoteToken.decimals()) * 3) / 5,
...
//
//        uint256 expectedFee = (4000 * (10**quoteToken.decimals()) * Constants.FEE) / Constants.FEE_PRECISION;
//
//        vm.expectEmit(true, false, false, true);
