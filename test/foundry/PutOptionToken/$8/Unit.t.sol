...
//import "../../../../contracts/arbitrum/Arbitrum$8PutOption.sol";
//
//contract $8PutOptionUnitTest is Test {
...
//
//    Arbitrum$8PutOption optionToken;
//
...
//
//        optionToken = new Arbitrum$8PutOption(address(underlyingToken), address(quoteToken), 1 days);
//
...
//            expectedOptionAmount: 3333333250000000000,
...
//        optionToken.write(1);
//
//        uint256 _maximumAmountToRevert = 10**(18 - quoteToken.decimals()) / 8 - 1;
//        vm.expectRevert("INVALID_AMOUNT");
//        optionToken.write(_maximumAmountToRevert);
//
//        uint256 _minimumAmountToNotRevert = 10**(18 - quoteToken.decimals()) / 8;
...
//            expectedQuoteAmount: 8000 * (10**quoteToken.decimals())
//        });
//
//        _cancel({
//            user: Constants.WRITER1,
...
//        uint256 _expectedOptionAmount = 3333333250000000000;
//        vm.prank(Constants.WRITER1);
//        optionToken.write(_optionAmount);
...
//        _cancel({
//            user: Constants.WRITER1,
//            optionAmount: 1666666500000000000,
//            expectedOptionAmount: 1666666500000000000,
//            expectedQuoteAmount: 13333332
//        });
//
//        _cancel({
//            user: Constants.WRITER1,
//            optionAmount: optionToken.balanceOf(Constants.WRITER1),
//            expectedOptionAmount: 1666666750000000000,
//            expectedQuoteAmount: 13333334
//        });
//        assertEq(optionToken.balanceOf(Constants.WRITER1), 0, "BEFORE_AFTER_BALANCE");
//    }
//
...
//            expectedQuoteAmount: (16000 * (10**quoteToken.decimals()) * (Constants.FEE_PRECISION - Constants.FEE)) /
...
//            expectedQuoteAmount: ((26666666 * (Constants.FEE_PRECISION - Constants.FEE)) / Constants.FEE_PRECISION) + 1,
//            // underlying and option decimals are same
...
//            expectedQuoteAmount: 24000 * (10**quoteToken.decimals()),
//            // No one exercised, so underlying amount is 0
//            expectedUnderlyingAmount: 0
//        });
//    }
...
//            user: Constants.WRITER1,
//            expectedOptionAmount: _optionAmount1,
//            // 16000 * 1e6 * (4000 * 1e18 / (4000 * 1e18 + 1000 * 1e18))
//            expectedQuoteAmount: (16000 * (10**quoteToken.decimals()) * 4) / 5,
...
//            user: Constants.WRITER1,
//            expectedOptionAmount: _optionAmount1,
//            // 16000 * 1e6 * (3000 * 1e18 / (3000 * 1e18 + 2000 * 1e18))
//            expectedQuoteAmount: (16000 * (10**quoteToken.decimals()) * 3) / 5,
...
//
//        uint256 expectedFee = (16000 * (10**quoteToken.decimals()) * Constants.FEE) / Constants.FEE_PRECISION;
//
//        vm.expectEmit(true, false, false, true);
